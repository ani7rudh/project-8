        				...
        				<div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
        					...
        					<div id="product-image-carousel-container">
        						<ul id="product-carousel" class="celastislide-list">
	        						...
	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}.jpg"><img src="resources/images/{{productdata.productId}}.jpg" alt="Phone photo 3"></a></li>
	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}.jpg"><img src="resources/images/{{productdata.productId}}.jpg" alt="Phone photo 4"></a></li>
	        						<li><a data-rel='prettyPhoto' href="resources/images/{{productdata.productId}}.jpg"><img src="resources/images/{{productdata.productId}}.jpg" alt="Phone photo 4"></a></li>
